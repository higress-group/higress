...
func remoteJWKsConfig(jwksURI string) json.RawMessage {
	return remoteJWKsConfigWithKeepToken(jwksURI, true)
}

func remoteJWKsConfigWithKeepToken(jwksURI string, keepToken bool) json.RawMessage {
...
func remoteJWKsConfigWithAuthorizationClaimHeader(jwksURI string) json.RawMessage {
	data, _ := json.Marshal(map[string]any{
		"global_auth": true,
		"consumers": []map[string]any{{
			"name":               "remote-consumer",
		...
		"consumers": []map[string]any{
			{
				...
				"issuer":             "higress-test",
				"jwks_uri":           "https://auth.example.com/.well-known/disallowed.json",
				"clock_skew_seconds": 2000000000,
			},
			{
				"name":               "allowed-remote-consumer",
				"issuer":             "higress-test",
				"jwks_uri":           "https://auth.example.com/.well-known/allowed.json",
				"clock_skew_seconds": 2000000000,
			},
		},
		...
		"consumers": []map[string]any{
			{
				...
				"issuer":             "higress-test",
				"jwks_uri":           "https://auth.example.com/.well-known/first.json",
				"clock_skew_seconds": 2000000000,
			},
			{
				"name":               "second-remote-consumer",
				"issuer":             "higress-test",
				"jwks_uri":           "https://auth.example.com/.well-known/second.json",
				"clock_skew_seconds": 2000000000,
			},
		},
		"_rules_": []map[string]any{{
		...
		"consumers": []map[string]any{
			{
				"name":               "allowed-remote-consumer",
				"issuer":             "higress-test",
				"jwks_uri":           "https://auth.example.com/.well-known/allowed-priority.json",
				"clock_skew_seconds": 2000000000,
			},
			{
		...
		"consumers": []map[string]any{
			{
				"name":               "allowed-remote-consumer",
				"issuer":             "higress-test",
				"jwks_uri":           "https://auth.example.com/.well-known/allowed-mutation.json",
				"clock_skew_seconds": 2000000000,
				"keep_token":         false,
			},
			{
		...
		"consumers": []map[string]any{
			{
				"name":               "remote-consumer",
				"issuer":             "higress-test",
				"jwks_uri":           "https://auth.example.com/.well-known/miss-before-inline.json",
				"clock_skew_seconds": 2000000000,
			},
			{
